              ...
              <div class="minipad">
                <table>
                  <tr>
                    ...
                    <td><input name="language[<?php echo $extension['language_id']; ?>][name]" value="<?php echo $extension['name']; ?>" />
                      <?php if ($error_name) { ?>
                  ...
                  <tr>
                    ...
                    <td><textarea name="language[<?php echo $extension['language_id']; ?>][description]" cols="40" rows="5"><?php echo $extension['description']; ?></textarea>
