...
<link rel="stylesheet" type="text/css" href="template/default/css/order.css">
    ...
    <div class="b">
      <table class="c">
        <tr>
          ...
          <th class="left"><?php echo $text_model; ?></th>
      ...
      <table class="g">
        ...
        <tr>
          ...
          <td class="center"><?php if ($history['notify']) { ?>
            <img src="template/default/image/enabled.png" />
            <?php } else { ?>
            <img src="template/default/image/disabled.png" />
            <?php } ?></td>
        </tr>
        <?php } ?>
      </table>
